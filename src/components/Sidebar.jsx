...
import { FaHome, FaTable, FaBox, FaTruck,FaFileInvoice,FaBriefcase, FaShoppingCart, FaUsers, FaCog,FaSignOutAlt, FaClipboard ,FaTrash,FaUserCheck } from "react-icons/fa"
...
const menuItems = [
    ...
    {name: "GatePass", path:"/admin/dashboard/gatepass", icon: <FaUserCheck />, isParent:false},
